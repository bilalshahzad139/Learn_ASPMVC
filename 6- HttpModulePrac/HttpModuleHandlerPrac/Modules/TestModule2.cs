...
namespace HttpModuleHandlerPrac
{
    ...
    */
    public class TestModule2 : IHttpModule
    {
        /// <summary>
        ...
        private void WriteToResponse(object sender, string message)
        {
            ...
            context.Response.Write(String.Format("<font color=red>{0}</font><hr>", message));
        }
